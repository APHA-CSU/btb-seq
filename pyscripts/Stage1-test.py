...
missingSites=strainsInfo[0].index('MissingSites')
outcome=strainsInfo[0].index('Outcome')
strainsInfo=listT(strainsInfo)
strainsDetails=listT([strainsInfo[pfileName][1:],strainsInfo[genomeCov][1:],strainsInfo[pmeanCov][1:],strainsInfo[totalReads][1:],strainsInfo[ppermap][1:],strainsInfo[missingSites][1:],strainsInfo[outcome][1:]])

strainsDetails=[['Sample','GenomeCov','MeanDepth','NumRawReads','pcMapped','MissingSites','Outcome',]]+strainsDetails
