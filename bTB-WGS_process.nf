...
process IDnonbovis{
	...
	$dependpath/Kraken2/kraken2 --memory-map --threads 2 --quick $lowmem --db $kraken2db --output - --report ${pair_id}_"\$outcome"_kraken2.tab --paired ${pair_id}_trim_R1.fastq  ${pair_id}_trim_R2.fastq 
