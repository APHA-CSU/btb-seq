...
process Mask {
	...
	"""
	mask.bash $RepeatBed mapped.bam mask.bed
	"""
}
...
process VCF2Consensus {
	...
	"""
	vcf2Consensus.bash $ref mask.bed variant.vcf.gz ${pair_id}_consensus.fas ${pair_id}_snps.tab ${pair_id}_filtered.bcf $NoRepeatBed
	"""
}
