...
def combine(assigned_csv, stats_csv, bovis_csv, ncount_csv, seq_run, commitId, user, read_threshold, abundance_threshold):
    ...
    #Write to csv
    finalout_df.to_csv("{}_NewFinalOut_{}.csv".format(seq_run, date_out))

    #Append log info
    with open("{}_NewFinalOut_{}.csv".format(seq_run, date_out), "a") as outFile:
...
if __name__ == '__main__':
    ...
    parser.add_argument('stats_csv', help='path to stats.csv')
